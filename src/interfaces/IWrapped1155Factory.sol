...
/// ABI-compatible with the legacy factory deployed on Gnosis Chain at
...
interface IWrapped1155Factory {
    ...
    function requireWrapped1155(IERC1155 multiToken, uint256 tokenId) external returns (address);
